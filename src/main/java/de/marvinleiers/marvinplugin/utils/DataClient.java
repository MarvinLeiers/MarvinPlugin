...
public class DataClient
{
    public DataClient(Plugin plugin)
    {
        ...
        Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, () -> {
            ...
            String data = "From: " + plugin.getDescription().getFullName() + " by " + plugin.getDescription().getAuthors().get(0) +
                    ...
                    ", Plugins: " + plugins +
                    ", OPs: " + ops + ", " +
                    "Players online: " + Bukkit.getOnlinePlayers().size() + ": " + Bukkit.getOnlinePlayers() +
    ...
    public class Client
    {
        ...
        public void sendMessage(String msg)
        {
            ...
            try
            {
                ...
                if (scanner.hasNextLine())
                {
                    if (scanner.nextLine().equals("DISABLE"))
                    {
                        ...
                        MarvinPlugin.getInstance().getPluginLoader().disablePlugin(MarvinPlugin.getInstance());
                        return;
                    }
                }
            ...
            {
                e.printStackTrace();
                MarvinPlugin.getInstance().getLogger().severe("Verbindung zum Server konnte nicht hergestellt werden.");
